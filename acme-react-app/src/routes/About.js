  ...
  return(
    <main className="main">
      <section class="about-box about-box-full">
        ...
        <p>Sit dolor quaerat ipsa expedita sed ea. Suscipit distinctio quaerat totam ex sequi eos, hic libero. Repellat laborum unde quae quaerat aliquid exercitationem exercitationem? Dolores eligendi eos quam lorem laudantium. Deleniti similique corporis porro iure odit? Sit necessitatibus quis ipsum?</p>
        <p>Elit consequuntur itaque repellat sed minima Consequuntur magnam ab nam rem corporis! Inventore nesciunt impedit ut distinctio maiores Et nam pariatur similique ea ullam? Quibusdam sed impedit dicta quos debitis? Odio cumque laborum et blanditiis eligendi Ipsa nobis amet laboriosam.</p>
      </section>
    </main>
  );
}
